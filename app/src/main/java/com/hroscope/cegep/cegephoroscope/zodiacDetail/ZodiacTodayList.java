...
public class ZodiacTodayList {
  ...
  //To retrieve data following variable name must matches with the firebase key.
    ...
    public ZodiacTodayList() {
        // Default constructor required for calls to DataSnapshot.getValue(Email_Registered_UserList.class)
    }

    public ZodiacTodayList(String first_name, String Last_name, String Email, String date, String zodiac_sign, String chinese_zodiac_sign, String sign_name) {
